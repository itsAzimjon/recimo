                ...
                <div class="col-lg-6 col-md-8 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
                    <div class="nav-wrapper position-relative end-0">
                        <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link mb-0 px-0 py-1 " data-bs-toggle="tab" href="#menu2" role="tab" aria-controls="teams" aria-selected="false">
                            ...
                            <li class="nav-item">
                                <a class="nav-link mb-0 px-0 py-1 " data-bs-toggle="tab" href="#menu3" role="tab" aria-controls="dashboard" aria-selected="false">
                ...
                <table class="table align-items-center mb-0">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <p class="text-xs font-weight-bold mb-0">150 kg</p>
                          <p class="text-xs text-secondary mb-0">400 000 Sum</p>
                        </td>
                      ...
                      <tr>
                        ...
                        <td class="align-middle text-center text-sm">
                          ...
                          <p class="text-xs text-secondary mb-0">Kardon</p>

            ...
            <div class="row p-4">
                <div class="col-md-6">
                    <form action="{{ route('region.store')}}" method="POST">
                        ...
                        <div class="input-group mb-3">
                            <input required type="text" name="name" class="form-control " aria-label="Text input with checkbox">
                ...
                <div class="col-md-6">
                    <form action="{{ route('area.store')}}" method="POST">
                        ...
                        <div class="input-group mb-3">
                            <input required type="text" name="name" class="form-control " aria-label="Text input with checkbox">
                            <select required class="form-select" name="region_id" aria-label="Default select example">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="input-group mb-3">
                                            <input required type="text" class="form-control" name="name" value="{{ $region->name }}" aria-label="Text input with checkbox">
                                        </div>
                                    </div>
                        ...
                        <div class="modal fade" id="area{{ $area->id }}" tabindex="-1" aria-labelledby="exampleModalLabel{{ $area->id }}" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="input-group mb-3">
                                            <input required type="text" class="form-control" name="name" value="{{ $area->name }}" aria-label="Text input with checkbox">
                                        </div>
